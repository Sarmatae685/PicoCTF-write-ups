...
> [!TIP]
> Put `message.txt` and script in one directory.
> This script as well as others I left here: [*click*](https://github.com/Sarmatae685/PicoCTF-write-ups/blob/main/content/scripts/cryptography/substitution2/solve.py)
